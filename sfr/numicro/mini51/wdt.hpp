...
namespace sfr {
    namespace wdt {                                 // Watchdog Timer Control Registers
        ...
        union wtcr_t {                              // Watchdog Timer Control Register (WTCR)
            ...
            sfb_t<wtcr_t, uint32_t, 0, 1> WTR;
            sfb_t<wtcr_t, uint32_t, 1, 1> WTRE;
            sfb_t<wtcr_t, uint32_t, 2, 1> WTRF;
            sfb_t<wtcr_t, uint32_t, 3, 1> WTIF;
            sfb_t<wtcr_t, uint32_t, 4, 1> WTWKE;
            sfb_t<wtcr_t, uint32_t, 5, 1> WTWKF;
            sfb_t<wtcr_t, uint32_t, 6, 1> WTIE;
            sfb_t<wtcr_t, uint32_t, 7, 1> WTE;
            sfb_t<wtcr_t, uint32_t, 8, 3> WTIS;
            sfb_t<wtcr_t, uint32_t, 31, 1> DBGACK_WDT;
        };
