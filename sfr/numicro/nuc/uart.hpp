...
namespace sfr {
    namespace uart {                                // UART Control Registers
        ...
        union ier_t {                               // Interrupt Enable Register (UA_IER)
            ...
            sfb_t<ier_t, 14, 1> DMA_TX_EN;
            sfb_t<ier_t, 15, 1> DMA_RX_EN;
        };
        ...
        union isr_t {                               // Interrupt Status Control Register (UA_ISR)
            ...
            sfb_t<isr_t, 18, 1> HW_RLS_IF;
            sfb_t<isr_t, 19, 1> HW_MODEM_IF;
            sfb_t<isr_t, 20, 1> HW_TOUT_IF;
            sfb_t<isr_t, 21, 1> HW_BUF_ERR_IF;
            sfb_t<isr_t, 26, 1> HW_RLS_INT;
            sfb_t<isr_t, 27, 1> HW_MODEM_INT;
            sfb_t<isr_t, 28, 1> HW_TOUT_INT;
            sfb_t<isr_t, 29, 1> HW_BUF_ERR_INT;
        };
