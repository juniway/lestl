...
namespace sfr {
    namespace spi {                                 // SPI Control Registers
        ...
        union cntrl2_t {                            // SPI Control and Status Register 2 (SPI_CNTRL2)
            __SFR(cntrl2_t, uint32_t, 0)
            sfb_t<cntrl2_t, 0, 1> DIV_ONE;
            sfb_t<cntrl2_t, 8, 1> NOSLVSEL;
            sfb_t<cntrl2_t, 9, 1> SLV_ABORT;
            sfb_t<cntrl2_t, 10, 1> SSTA_INTEN;
            sfb_t<cntrl2_t, 11, 1> SLV_START_INTSTS;
        };
        ...
        struct spi_t {
            ...
            uint32_t :32;
            volatile sfr_t<cntrl2_t> CNTRL2;        // SPI Control and Status Register 2 (SPI_CNTRL2)
        };
